...
`,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("qbee_node_filedistribution.test", "files.0.command"),
					resource.TestCheckNoResourceAttr("qbee_node_filedistribution.test", "files.0.pre_condition"),
